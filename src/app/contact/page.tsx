...
// Note: In a real application, you would export metadata from a separate server component
// For now, we'll handle the form client-side
...
export default function Contact() {
  ...
  return (
    <>
      {/* Metadata would be handled in a server component wrapper in production */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              you achieve your goals with innovative digital solutions.
            </p>
          </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="mailto:hello@shadojus.com" className="text-blue-600 hover:text-blue-700">
                        hello@shadojus.com
                      </a>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div className="space-y-4">
                  <a href="#" className="flex items-center p-3 rounded-lg hover:bg-gray-50 transition-colors">
                    <svg className="w-6 h-6 text-blue-500 mr-4" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">@shadojus</div>
                    </div>
                  </a>
                  
                  <a href="#" className="flex items-center p-3 rounded-lg hover:bg-gray-50 transition-colors">
                    <svg className="w-6 h-6 text-gray-900 mr-4" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="#" className="flex items-center p-3 rounded-lg hover:bg-gray-50 transition-colors">
                    <svg className="w-6 h-6 text-blue-700 mr-4" fill="currentColor" viewBox="0 0 24 24">
